...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    data: json["data"] == null ? null : List<SingleQuestionModel>.from(json["data"].map((x) => SingleQuestionModel.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "data": data == null ? null : List<SingleQuestionModel>.from(data!.map((x) => x.toJson())),
